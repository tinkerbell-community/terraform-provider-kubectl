...
func getAttributesValuesFromResource(state *Helper, address string) (any, error) {
...
func getOutputValues(state *Helper, name string) (any, error) {
...
func findAttributeValue(in any, address string) (any, error) {
...
func (s *Helper) GetAttributeValue(t *testing.T, address string) any {
	t.Helper()
...
func (s *Helper) GetIdentityValue(t *testing.T, address string, identitykey string) any {
	t.Helper()
...
func (s *Helper) GetOutputValue(t *testing.T, name string) any {
	t.Helper()
...
func (s *Helper) AssertAttributeEqual(t *testing.T, address string, expectedValue any) {
	t.Helper()
...
func (s *Helper) AssertIdentityValueEqual(
	t *testing.T,
	address string,
	identitykey string,
	expectedValue any,
...
func (s *Helper) AssertAttributeNotEqual(t *testing.T, address string, expectedValue any) {
	t.Helper()
