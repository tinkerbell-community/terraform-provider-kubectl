...
func (k *Helper) CreateConfigMap(t *testing.T, name string, namespace string, data map[string]any) {
	t.Helper()
	...
	_, err := k.dynClient.Resource(gvr).
		Namespace(namespace).
		Create(context.TODO(), cfgmap, metav1.CreateOptions{})
	if err != nil {
...
func (k *Helper) DeleteNamespacedResource(
	t *testing.T,
	name string,
	namespace string,
...
// specified namespace
func (k *Helper) AssertNamespacedResourceExists(
	t *testing.T,
	gv, resource, namespace, name string,
) {
	t.Helper()
	...
	op := func() error {
		_, operr := k.dynClient.Resource(gvr).
			Namespace(namespace).
...
func (k *Helper) AssertResourceGeneration(
	t *testing.T,
	gv, resource, namespace, name string,
	generation int64,
) {
...
func (k *Helper) AssertNamespacedResourceDoesNotExist(
	t *testing.T,
	gv, resource, namespace, name string,
) {
	t.Helper()
