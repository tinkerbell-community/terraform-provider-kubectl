...
func HelperSchemaDebug(ctx context.Context, msg string, additionalFields ...map[string]any) {
...
func HelperSchemaError(ctx context.Context, msg string, additionalFields ...map[string]any) {
...
func HelperSchemaTrace(ctx context.Context, msg string, additionalFields ...map[string]any) {
...
func HelperSchemaWarn(ctx context.Context, msg string, additionalFields ...map[string]any) {
