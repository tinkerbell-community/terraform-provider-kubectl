...
func TestKubernetesManifest_CustomResource_OAPIv3_metadata(t *testing.T) {
	...
	tfconfig := loadTerraformConfig(
		t,
		"CustomResourceOAPI3-metadata/custom_resource_definition.tf",
		tfvars,
	)
	...
	tfstate.AssertAttributeValues(t, tfstatehelper.AttributeValues{
		...
		"kubernetes_manifest.test_cr.object.spec.users.foo_user": []any{"superuser"},
		"kubernetes_manifest.test_cr.object.spec.users.bar_user": []any{},
		"kubernetes_manifest.test_cr.object.spec.users.mike": []any{
			"superuser",
			"createdb",
		},
	...
	tfstate.AssertAttributeEmpty(
		t,
		"kubernetes_manifest.test_cr.object.spec.clone.s3_access_key_id",
	)
	tfstate.AssertAttributeEmpty(t, "kubernetes_manifest.test_cr.object.spec.clone.s3_endpoint")
	tfstate.AssertAttributeEmpty(
		t,
		"kubernetes_manifest.test_cr.object.spec.clone.s3_force_path_style",
	)
	tfstate.AssertAttributeEmpty(
		t,
		"kubernetes_manifest.test_cr.object.spec.clone.s3_secret_access_key",
	)
	...
	tfstate.AssertAttributeEmpty(
		t,
		"kubernetes_manifest.test_cr.object.spec.connectionPooler.dockerImage",
	)
	tfstate.AssertAttributeEmpty(
		t,
		"kubernetes_manifest.test_cr.object.spec.connectionPooler.maxDBConnections",
	)
	tfstate.AssertAttributeEmpty(t, "kubernetes_manifest.test_cr.object.spec.connectionPooler.mode")
	tfstate.AssertAttributeEmpty(
		t,
		"kubernetes_manifest.test_cr.object.spec.connectionPooler.numberOfInstances",
	)
	tfstate.AssertAttributeEmpty(
		t,
		"kubernetes_manifest.test_cr.object.spec.connectionPooler.schema",
	)
	...
	tfstate.AssertAttributeNotEmpty(
		t,
		"kubernetes_manifest.test_cr.object.spec.connectionPooler.resources",
	)

	tfstate.AssertAttributeEmpty(t, "kubernetes_manifest.test_cr.object.spec.dockerImage")
	tfstate.AssertAttributeEmpty(
		t,
		"kubernetes_manifest.test_cr.object.spec.enableConnectionPooler",
	)
	tfstate.AssertAttributeEmpty(t, "kubernetes_manifest.test_cr.object.spec.enableLogicalBackup")
	tfstate.AssertAttributeEmpty(
		t,
		"kubernetes_manifest.test_cr.object.spec.enableMasterLoadBalancer",
	)
	tfstate.AssertAttributeEmpty(
		t,
		"kubernetes_manifest.test_cr.object.spec.enableReplicaConnectionPooler",
	)
	tfstate.AssertAttributeEmpty(
		t,
		"kubernetes_manifest.test_cr.object.spec.enableReplicaLoadBalancer",
	)
	...
	tfstate.AssertAttributeEmpty(
		t,
		"kubernetes_manifest.test_cr.object.spec.nodeAffinity.preferredDuringSchedulingIgnoredDuringExecution",
	)
	tfstate.AssertAttributeNotEmpty(
		t,
		"kubernetes_manifest.test_cr.object.spec.nodeAffinity.requiredDuringSchedulingIgnoredDuringExecution",
	)
	...
	tfstate.AssertAttributeEmpty(
		t,
		"kubernetes_manifest.test_cr.object.spec.patroni.maximum_lag_on_failover",
	)
	...
	tfstate.AssertAttributeEmpty(
		t,
		"kubernetes_manifest.test_cr.object.spec.patroni.synchronous_mode",
	)
	tfstate.AssertAttributeEmpty(
		t,
		"kubernetes_manifest.test_cr.object.spec.patroni.synchronous_mode_strict",
	)
	...
	tfstate.AssertAttributeEmpty(
		t,
		"kubernetes_manifest.test_cr.object.spec.pod_priority_class_name",
	)
	...
	tfstate.AssertAttributeEmpty(
		t,
		"kubernetes_manifest.test_cr.object.spec.resources.limits.memory",
	)
	tfstate.AssertAttributeNotEmpty(t, "kubernetes_manifest.test_cr.object.spec.resources.requests")
	tfstate.AssertAttributeEmpty(
		t,
		"kubernetes_manifest.test_cr.object.spec.resources.requests.cpu",
	)
	tfstate.AssertAttributeEmpty(
		t,
		"kubernetes_manifest.test_cr.object.spec.resources.requests.memory",
	)
