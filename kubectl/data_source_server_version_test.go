		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttrSet("data.kubectl_server_version.test", "version"),
					...
					resource.TestCheckResourceAttrSet("data.kubectl_server_version.test", "git_version"),
					resource.TestCheckResourceAttrSet("data.kubectl_server_version.test", "platform"),
