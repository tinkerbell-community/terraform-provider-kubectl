	...
	samples := map[string]struct {
		...
		"tuple(object)->list(object)": {
			In: sampleInType{
				V: tftypes.NewValue(tftypes.Tuple{ElementTypes: []tftypes.Type{
					...
					tftypes.Object{
						AttributeTypes: map[string]tftypes.Type{"foo": tftypes.DynamicPseudoType},
					},
					tftypes.Object{AttributeTypes: map[string]tftypes.Type{"foo": tftypes.String}},
				}},
					[]tftypes.Value{
						tftypes.NewValue(
							tftypes.Object{
								AttributeTypes: map[string]tftypes.Type{"foo": tftypes.String},
							},
						...
						tftypes.NewValue(
							tftypes.Object{
								AttributeTypes: map[string]tftypes.Type{
									"foo": tftypes.DynamicPseudoType,
								},
							},
							map[string]tftypes.Value{
								"foo": tftypes.NewValue(tftypes.DynamicPseudoType, nil),
							},
						),
						tftypes.NewValue(
							tftypes.Object{
							...
							map[string]tftypes.Value{
								"foo": tftypes.NewValue(tftypes.String, "baz"),
							},
						),
					}),
				T: tftypes.List{
		...
		"tuple(object)->tuple(object)": {
			In: sampleInType{
				V: tftypes.NewValue(
					tftypes.Tuple{ElementTypes: []tftypes.Type{
						tftypes.Object{
							AttributeTypes: map[string]tftypes.Type{"first": tftypes.String},
						},
						tftypes.Object{
							AttributeTypes: map[string]tftypes.Type{
								"second": tftypes.DynamicPseudoType,
							},
						},
						tftypes.Object{AttributeTypes: map[string]tftypes.Type{
							"third": tftypes.Tuple{ElementTypes: []tftypes.Type{
								...
								tftypes.Object{
									AttributeTypes: map[string]tftypes.Type{"bar": tftypes.String},
								},
							}},
						}},
					}},
					[]tftypes.Value{
						tftypes.NewValue(
							...
							map[string]tftypes.Value{
								"first": tftypes.NewValue(tftypes.String, "foo"),
							},
						),
						...
						tftypes.NewValue(
							...
							map[string]tftypes.Value{
								"second": tftypes.NewValue(tftypes.DynamicPseudoType, nil),
							},
						),
			...
			Out: tftypes.NewValue(tftypes.Tuple{ElementTypes: []tftypes.Type{
				...
				tftypes.Object{
					AttributeTypes: map[string]tftypes.Type{"second": tftypes.DynamicPseudoType},
				},
				tftypes.Object{
					AttributeTypes: map[string]tftypes.Type{
						"third": tftypes.Tuple{ElementTypes: []tftypes.Type{
	...
	samples := map[string]struct {
		...
		"string->number": {
			...
			Attribute: tftypes.NewAttributePath().
				WithAttributeName("foo").
				WithElementKeyString("bar"),
			Diags: []*tfprotov6.Diagnostic{
				{
