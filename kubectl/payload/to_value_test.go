...
func TestToTFValue(t *testing.T) {
	samples := map[string]struct {
		...
		"int-or-string-to-int": {
			...
			Th: map[string]string{
				tftypes.NewAttributePath().String(): "io.k8s.apimachinery.pkg.util.intstr.IntOrString",
			},
			Err: nil,
		},
		...
		"list": {
			In: sampleInType{[]any{"test1", "test2"}, tftypes.List{ElementType: tftypes.String}},
		...
		"list-int-or-string": {
			In: sampleInType{[]any{"test1", 2}, tftypes.List{ElementType: tftypes.String}},
			Th: map[string]string{
				tftypes.NewAttributePath().WithElementKeyInt(-1).String(): "io.k8s.apimachinery.pkg.util.intstr.IntOrString",
			},
			Out: tftypes.NewValue(tftypes.List{ElementType: tftypes.String}, []tftypes.Value{
				tftypes.NewValue(tftypes.String, "test1"),
		...
		"list (empty)": {
			In:  sampleInType{[]any{}, tftypes.List{ElementType: tftypes.String}},
			Out: tftypes.NewValue(tftypes.List{ElementType: tftypes.String}, []tftypes.Value{}),
			Err: nil,
		},
		"set": {
			In: sampleInType{[]any{"test1", "test2"}, tftypes.Set{ElementType: tftypes.String}},
		...
		"set (empty)": {
			In:  sampleInType{[]any{}, tftypes.Set{ElementType: tftypes.String}},
			Out: tftypes.NewValue(tftypes.Set{ElementType: tftypes.String}, []tftypes.Value{}),
			Err: nil,
		},
		"tuple": {
