Review the implementation in the hashicorp/kubernetes provider to compare the functionality with what is present in the hashicorp-oss/kubectl provider.
